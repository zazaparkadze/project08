  ...
  const content = (
    <div className="flex flex-col w-fit gap-y-2">
      ...
      <div className="flex gap-2 mt-2">
        <p className="text-3xl bg-slate-800 text-amber-400 py-5 px-15 rounded-[15px] grow-1">
      ...
      <div className=" text-black p-6 rounded-2xl bg-gradient-to-r from-gray-600 to-gray-200">
